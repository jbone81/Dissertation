\begin{appendices}
  ...
  \subsection{Core Dimension: Awareness} 
  \subsection{Primary Research Question --- RQ1}
...
\begin{figure}
    ...
    \caption{Taxonomoy of Survey Questions}
...
\subsection{Core Dimension: Applicability}
\subsection{Primary Research Questions --- RQ2, RQ3}
...
\begin{table}[H]
  ...
  \subsection{Core Dimension Perceived Value (IT Domain)}
  \subsection{Primary Research Questions --- RQ2, RQ3}
  ...
  \subsection{Core Dimension: Perceived Value (Information Assurance Domain)}
  \subsection{Primary Research Questions --- RQ2, RQ3}
  ...
  \subsection{Core Dimension: Supporting/Demographics}
  ...
  \begin{table}[H]
    ...
    \begin{tabular}{@{}lp{2in}p{1.2in}c@{}}
      ...
      \midrule
      RQ2 (Perceived Value) & Q3.1, Q3.2, Q3.6, Q4.1, Q4.5, Q5.1, Q5.7 & Q6.1, Q6.2 & 7 (+2) \\
      \midrule
