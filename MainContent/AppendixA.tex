...
\clearpage
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\linewidth]{Figures/ResearchQuestionTaxonomy.png}
...
\begin{landscape}
    \begin{figure}
    \centering
    \includegraphics[width=.9\linewidth]{Figures/OverviewDiagramOfPackageSurveyQuestions.png}
