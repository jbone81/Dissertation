...
The academic research gap is pronounced. Systematic literature reviews examining MBSE consistently find no research addressing enterprise IT infrastructure or Information Assurance applications. The sole exception is the reference model by \citeauthor{Bonar_Hastings_2024}~\cite{Bonar_Hastings_2024}. This gap persists despite explicit requirements in compliance frameworks for capabilities that Digital Engineering provides.
...
\subsection{Digital Engineering as Disciplinary Solution}
