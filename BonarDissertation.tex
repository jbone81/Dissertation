...
\usepackage[letterpaper, left=1.1in, right=1in, top=1in, bottom=1in]{geometry}
\usepackage{fancyhdr}
...
\usepackage{varioref}
\usepackage[linktocpage=true,bookmarks=true,hidelinks]{hyperref}
\usepackage[capitalise,noabbrev]{cleveref}
%\usepackage[backend=biber,style=ieee,sorting=none]{biblatex} % ieee citation style
\usepackage[backend=biber,style=apa,language=american,maxnames=4,minnames=3,sortcites=true]{biblatex} % apa citation style
